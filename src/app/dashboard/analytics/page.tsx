      ...
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-xl p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          {metrics.map((metric, index) => (
            <div className={`flex justify-between items-center bg-white rounded-lg shadow-md p-6 border-l-4 ${metric.isPositive ? "border-green-500" : "border-red-500"}`} key={index}>
              <div className="">
        ...
        <ul className="space-y-4">
          <li className="flex items-center justify-between bg-white rounded-lg shadow-md p-4">
            <div className="">
              ...
              <p className="text-sm text-gray-600">New user signed up on 2026-02-12</p>
            </div>
            <div className="">
