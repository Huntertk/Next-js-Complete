    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 p-8">
      <div className="max-w-7xl mx-auto bg-white rounded-lg shadow-sm p-8">
        ...
        <section className='space-y-6'>
          {tasks.map((task) => {
            return <div key={task.id} className='flex items-center justify-between bg-white rounded-lg shadow-md p-6 border-l-4' style={{
              ...
              <section className='flex space-x-4'>
                ...
                {/* Buttons */}
                <button className='px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors cursor-pointer'>Edit</button>
              {
                ...
                <button className='px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors cursor-pointer'>Delete</button>
              </section>
            </div>
          })}
        </section>
